<!-- content -->
<div id="container">
    <h1><span class="big">H</span><span class="small">ighland</span></h1>
    ...
    <p>
        Za čistokrvné sú považované len zvieratá bez akéhokoľvek podielu krvi iného plemena. 
        Z takýchto zvierat sú v rámci bonitácií vyberané matky pre produkciu plemenných býčkov, 
        ktoré sú zároveň hlavnou základňou pre produkciu kvalitného plemenného materiálu pre chovy v SR.
    </p>
    <p>
        Charakteristické vlastnosti plemena Highland sú tvrdosť, nenáročnosť a dlhovekosť, 
        ľahký priebeh pôrodu, veľmi kľudná povaha a vynikajúce materské vlastnosti. 
        Zvlášť cenená vlastnosť je vynikajúca pastevná schopnosť aj na veľmi extenzívnych porastoch. 
    </p>
</div>
